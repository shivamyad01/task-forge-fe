...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#E9EEFF]">
      <div className="w-full md:w-1/5 flex items-center justify-center bg-gradient-to-r from-[#8DE1D7] to-[#86E6D9] py-6 md:py-12">
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="mt-4 sm:mt-6 space-y-4">
            ...
            <div>
              <button
                onClick={handleLogin}
                className="w-full py-4 sm:py-3 rounded-full bg-gradient-to-r from-[#FF9900] to-[#FFB86B] font-bold shadow-md hover:opacity-95 text-lg sm:text-base"
              >
                LOGIN
              </button>
            </div>
